...
jQuery.validator.addMethod("idProofFormate", function(value, element) {
    ...
    if($("#id_proof").val()==1) {
       ...
       return this.optional(element) || /^[A-Z]{5}\d{4}[A-Z]{1}$/.test(value); // Pan card regex
   }
...
jQuery.validator.addMethod("notEqulToMobileNumber", function(value, element) {
   return this.optional(element) ||  $('#alternate_mobile_number').val() != $('#mobile_number').val();
...
//   return this.optional(element) ||  $('#alternate_email').val() != $('#email').val();
